...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="Radar Imobiliário do Vale do Aço — Análise quantitativa do mercado de Ipatinga-MG. {edicao}. Dados reais de {n_total} anúncios verificados. Por Wederson Marinho, Data Scientist | Perito Judicial | Especialista em Mercado Imobiliário.">
...
<header>
  <div class="hdr">
    ...
    <div>
      ...
      <div class="analyst-cred">Data Scientist | Perito Judicial | Especialista Mercado Imobiliário · CRECI-MG 58.263-F · CNAI 51.239</div>
    </div>
  </div>
</header>
...
<div class="main">
  ...
  <div style="background:#F0F9FF;border:1px solid #0EA5E9;border-radius:8px;padding:12px 14px;font-size:.75rem;color:#0369A1;text-align:center;margin-bottom:16px;">
    <strong>Última atualização:</strong> {data_coleta} · <strong>Reprodutibilidade:</strong> <a href="https://github.com/marinhobusiness/radar-vale-do-aco-mg" style="color:#0369A1;text-decoration:underline;">GitHub</a> · <a href="https://doi.org/10.5281/zenodo.19601663" style="color:#0369A1;text-decoration:underline;">DOI 10.5281/zenodo.19601663</a>
  </div>

  <div class="sec-lbl">Publicação Científica · Acesso Aberto e Reprodutível</div>
  <div class="card c-navy" style="text-align:center;padding:16px;">
    <div style="font-size:.73rem;color:rgba(255,255,255,.5);margin-bottom:8px;text-transform:uppercase;letter-spacing:.08em;">Citação recomendada</div>
    <div style="font-size:.85rem;color:#E8C97A;font-family:'IBM Plex Mono',monospace;line-height:1.5;margin-bottom:10px;">
      Marinho, W. (2026). Radar Imobiliário do Vale do Aço - Ipatinga-MG Q2/2026. <strong>Zenodo.</strong> 
      <a href="https://doi.org/10.5281/zenodo.19601663" style="color:#E8C97A;">https://doi.org/10.5281/zenodo.19601663</a>
    </div>
    <div style="font-size:.72rem;color:rgba(255,255,255,.3);">
      Dataset com validação de 7 pontos · Testes estatísticos (Shapiro-Wilk, Levene, t-test) · Licença CC BY 4.0
    </div>
  </div>
  ...
  <div class="card c-blue">
    ...
    <p class="note" style="margin-top:14px;">
      ...
      Análise: Wederson Marinho · CRECI-MG 58.263-F · CNAI 51.239 · Data Scientist | Perito Judicial | Especialista Mercado Imobiliário.
    </p>
  </div>
...
<footer>
  <div class="ftr">
    <div>
      ...
      <div class="f-creds">
        Wederson Marinho<br>
        Data Scientist | Perito Judicial | Especialista Mercado Imobiliário<br>
